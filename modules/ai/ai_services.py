...
def update_company_card(
    ...
    * **Volume:** (This rule is now handled in Task 6).
    ...
    {{
      ...
      "todaysAction": "STRICT: Max 4-5 sentences, under 5000 chars. Format: 'DATE: Pattern (State). [Brief 3-Act narrative of who acted at which key level and the outcome].'. Do NOT repeat content from other fields."
    }}
    """
...
def update_economy_card(
    ...
    system_prompt = (
        ...
        "CRITICAL RULE for 'todaysAction': This field is a CONCISE daily log entry (max 4-5 sentences, under 5000 characters). "
